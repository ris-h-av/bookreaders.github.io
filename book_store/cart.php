...
if(isset($_POST['update_cart'])){
    ...
    $cary_quantity = $_POST['cart_quantity'];

    mysqli_query($conn, "UPDATE `cart` SET quantity='$cary_quantity' WHERE id=$cart_id") or die('query failed');
    ...
    <section class="cart">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="total">
                    Total : <span> $<?php echo $total = ($fetch_cart['quantity'] * $fetch_cart['price']  ) ?>/-</span>
                </div>
            </div>
