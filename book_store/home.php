...
<body>
    ...
    <section class="home">
        <div class="content">
            <h3>Hand Picked books at your door.</h3>
            <p>Don't worry about where to find your favourite books beacuse we're here for YOU.
                Keep Reading keep Learning!
            </p>
            <a href="about.php" class="white-btn">Find more</a>
        </div>
    </section>
    ...
    <section class="about">
        ...
        <div class="flex">
            ...
            <div class="content">
                <h3>about us</h3>
                <p> book is a medium for recording information in the form of writing or images,
                     typically composed of many pages bound together and protected by a cover. It 
                     can also be handwritten or printed work of fiction or nonfiction, usually on 
